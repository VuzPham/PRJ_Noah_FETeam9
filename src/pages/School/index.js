...
function School() {
    ...
    const handleDelete = () => {
        if (selectedSchoolIndex !== null) {
            console.log(`Deleted school at index ${selectedSchoolIndex}`);
    ...
    const handleSaveChanges = () => {
        console.log('Saved changes:', editingSchool);
        const modal = new bootstrap.Modal(document.getElementById('editSchoolModal'));
        modal.hide();
    };
    ...
    return (
        <>
            {/* Edit School Modal */}
            <div className="modal fade" id="editSchoolModal" tabIndex="-1" aria-labelledby="editSchoolLabel" aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="editSchoolLabel">Edit School</h5>
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div className="modal-body">
                            {editingSchool && (
                                <form>
                                    ...
                                    <div className="mb-3">
                                        <label htmlFor="schoolImage" className="form-label">School Image URL</label>
                                        <input
                                            type="text"
                                            className="form-control"
                                            id="schoolImage"
                                            value={editingSchool.image}
                                            onChange={(e) => setEditingSchool({ ...editingSchool, image: e.target.value })}
                                        />
                                    </div>
                                    <img src={editingSchool.image} alt="School" className="img-fluid" />
                                </form>
                            )}
                        </div>
                        <div className="modal-footer">
            ...
            {/* View School Modal */}
            <div className="modal fade" id="viewSchoolModal" tabIndex="-1" aria-labelledby="viewSchoolLabel" aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="viewSchoolLabel">School Details</h5>
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div className="modal-body">
                            {viewingSchool && (
                                <div>
                                    <h5>{viewingSchool.name}</h5>
                                    <img src={viewingSchool.image} alt="School" className="img-fluid" />
                                </div>
                            )}
                        </div>
                        <div className="modal-footer">
            ...
            <div className={styles['button-actions']}>
                <div className={styles['crud']}>
                    ...
                    {/* <button type="button" className="btn btn-success"><EditOutlined /> Edit</button>
                    <button type="button" className="btn btn-danger">Delete</button> */}
                </div>
                <div className={styles['other-action']}>
                    <button
                            ...
                            <div className={`card ${styles.card}`}>
                                ...
                                <div className={`card-body ${styles['card-body']}`}>
                                    ...
                                    <div className={styles['card-actions']}>
                                        ...
                                        <EditOutlined onClick={() => handleEditClick(school)} />
                                        <DeleteOutlined
